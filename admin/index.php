...
{
$ret=mysqli_query($con,"SELECT * FROM admin WHERE emailAddress='".$_POST['emailAddress']."' and password='".$_POST['password']."'");
$num=mysqli_fetch_array($ret);
if($num>0)
{
$extra="home.php";
$_SESSION['alogin']=$num['emailAddress'];
$_SESSION['id']=$num['id'];
...
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          <h2>Sign in As Real Estate Admin</h2>
