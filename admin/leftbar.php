  ...
  <div class="page-sidebar" id="main-menu">
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
      <div class="user-info-wrapper">
        <div class="profile-wrapper"> <img src="assets/img/others/avatarM.png"  alt=""  width="69" height="69" /> </div>
        <div class="user-info">
          <div class="greeting">Welcome</div>
          <div class="username">&nbsp;&nbsp;Admin</div>
          <?php
            $qer=mysqli_query($con,"SELECT * FROM admin WHERE id='".$_SESSION['id']."'");
            $cnt=mysqli_fetch_array($qer);
            if($cnt>0)
            {
              echo $cnt['firstName']." ".$cnt['lastName'];
            }
          ?>
        </div>
      </div>
