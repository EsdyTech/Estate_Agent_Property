...
if(isset($_POST['change']))
{
 ...
 $sql=mysqli_query($con,"SELECT agent_password FROM  agent where agent_password='$oldpas' && agent_id='$agentid'");
$num=mysqli_fetch_array($sql);
if($newpassword !=  $confirmpassword){
  $_SESSION['msg1']="Password Mismatch !!";
}
else{
  if($num>0)
  {
    $con=mysqli_query($con,"update agent set agent_password='$newpassword' where agent_id='$agentid'");
