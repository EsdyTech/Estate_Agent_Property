...
<head>
<title>Real Estate Agent and Prorperty Management</title>
<meta charset="UTF-8" />
...
<!-- <a href="index.php"><img src="images/header.png" alt=" SLNP Realestate"></a> -->
            ...
            <div class="menu">
              <ul class="pull-right">
                ...
                <li><a href="list-properties.php">Users</a>
                	 <ul class="dropdown">
        ...
        <div class="sl-slider">
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
            <div class="sl-slide-inner">
              ...
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Banana Island, Lagos</p>
              <p>Until he extends the circle of his compassion to all living things, man will not himself find peace.</p>
              <cite>N 20,000,000</cite>
              </blockquote>
            </div>
          </div>
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">2 Bed Rooms and 1 Dinning Room Aparment on Sale</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Ikaje, Lagos</p>
              <p>Until he extends the circle of his compassion to all living things, man will not himself find peace.</p>
              <cite>N 20,000,000</cite>
              </blockquote>
            </div>
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">2 Bed Rooms and 1 Dinning Room Aparment on Sale</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Ayobo, Lagos</p>
              <p>Until he extends the circle of his compassion to all living things, man will not himself find peace.</p>
              <cite>N 20,000,000</cite>
              </blockquote>
            </div>
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="-5" data-slice2-rotation="25" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">2 Bed Rooms and 1 Dinning Room Aparment on Sale</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Igbesa, Ogun State</p>
              <p>Until he extends the circle of his compassion to all living things, man will not himself find peace.</p>
              <cite>N 20,000,000</cite>
              </blockquote>
            </div>
  ...
  <div class="properties-listing spacer"> <a href="list-properties.php" class="pull-right viewall">View All Listing</a>
    ...
    <div id="owl-example" class="owl-carousel">
      ...
      <div class="properties">
        ...
        <p class="price">Price: N<?php echo $price; ?></p>
  ...
  <div class="spacer">
    <div class="row">
      <div class="col-lg-12 col-sm-12 recent-view">
        <h3>About Us</h3>
        <p>At MAVIN Real Estate, you are number one. Whether you are a property owner, tenant, or buyer, we value your business and will provide you with the individual attention and service you deserve. We believe in a strict Code of Ethics. We believe in integrity, commitment to excellence, a professional attitude, and personalized care.<br><a href="#">Learn More</a></p>
      </div>
...
<div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
             ...
             <div class="col-lg-3 col-sm-3">
                    <h4>Contact us</h4>
                    <p><b>Real Estate Agent and Prorperty Management</b><br>
<span class="glyphicon glyphicon-map-marker"></span> Ahmed Sodiq, O<br>
<span class="glyphicon glyphicon-envelope"></span> Ahmedsodiq7@gmail.com<br>
<span class="glyphicon glyphicon-earphone"></span> 07065903222</p>
            </div>
        </div>
