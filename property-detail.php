...
<div class="well"><p class="price"> N <?php echo $price; ?></p></div>

  <p class="area"><div class="well"><span class="glyphicon glyphicon-map-marker"></span> <?php echo $property_address; ?> </div></p>

</div>

    <div class="well"><span class="glyphicon glyphicon-check"></span> &nbsp; <b>Status - <?php if($availablility == 0){echo "Available";} else {echo "Not Available";} ?></b></div>
